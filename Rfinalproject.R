...
#first part
library(readr)
global_air_pollution_dataset <- read_csv("C:\Users\amira\OneDrive\Desktop\global air pollution dataset.csv")
...
#second part
library(readr)
share_deaths_air_pollution <- read_csv("C:\Users\amira\OneDrive\Desktop\share-deaths-air-pollution.csv")
View(share_deaths_air_pollution)
 
library(readr)
Annual_Surface_Temperature_Change <- read_csv("C:\Users\amira\OneDrive\Desktop\Annual_Surface_Temperature_Change.csv")
...
#third part
library(readr)
Forest_and_Carbon1 <- read_csv("C:\Users\amira\OneDrive\Desktop\Forest_and_Carbon1.csv")
